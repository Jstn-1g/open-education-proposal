...
The [first public execution on 8 September 2026](https://github.com/Jstn-1g/open-education-proposal/actions/runs/34289746650) completed all three analyses on commit `b5a4b0be8968209fb680015bd7f9613b9c9a3c22`, with no reported findings, analysis errors, or warnings. Open code-scanning alerts were zero when reviewed. This result applies to that commit and the default query sets, not future changes or every possible vulnerability. Earlier private staging runs intentionally skipped analysis. A skipped, canceled, or failed run is not a passing scan. [GitHub documents code scanning availability and first-run verification](https://docs.github.com/en/code-security/how-tos/find-and-fix-code-vulnerabilities/configure-code-scanning/configuring-advanced-setup-for-code-scanning).

Before merging changes, confirm all three language jobs completed, results were processed, and no configuration error left files unexamined. Review the repository's [code scanning results](https://github.com/Jstn-1g/open-education-proposal/security/code-scanning) and record the commit, run URL, findings, and unresolved limits. The workflow also supports manual dispatch on `main`. Do not enable GitHub's separate default CodeQL setup alongside this workflow.
