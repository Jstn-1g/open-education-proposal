...
Python 3.11 or newer is enough; there is nothing to install. See [development and verification](DEVELOPMENT.md) for build, preview, and test commands.

Maintainers can use the prepared [checks and publishing workflow](docs/PUBLISHING.md). Checks do not publish the site; Pages deployment requires a separate manual run and a passing publication check.

See the [maintenance model](MAINTENANCE.md) and [first-month roadmap](docs/ROADMAP.md) for the responsibilities and evidence of usefulness we want to establish next.
