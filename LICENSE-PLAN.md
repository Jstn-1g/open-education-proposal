...
| --- | --- |
| `build.py`, `release_check.py`, `release.json`, `styles.css`, `tests/`, `.github/workflows/`, and `.gitignore` | Apache-2.0 |
| `content/` HTML fragments, including their markup; all Markdown documents | CC BY 4.0 |
| Generated website | Combination of the software frame/styles and the content above; distribute both notices |

Apache 2.0 supplies express patent terms and requires preservation of applicable notices. It does not grant trademark rights. CC BY 4.0 permits adaptation and commercial reuse with attribution and other license conditions. These are summaries; the [Apache license](https://www.apache.org/licenses/LICENSE-2.0) and [CC BY legal code](https://creativecommons.org/licenses/by/4.0/legalcode.en) control the grants.

## The tradeoff

This pair favors broad reuse, including commercial reuse. It does **not** require every downstream improvement to be shared back. A share-alike approach could require reciprocity but would change reuse and compatibility tradeoffs. The owner selected broad reuse for this first public proposal, while inviting improvements through the contribution process.
