...
Research papers are linked, not reproduced as project-owned resources. No third-party fonts, photographs, or library packages are bundled into the generated site. GitHub Actions referenced by the optional workflows retain their own licenses; the workflow source pins are documented in [publishing instructions](docs/PUBLISHING.md).
